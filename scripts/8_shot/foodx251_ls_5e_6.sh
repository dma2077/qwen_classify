...
# 配置参数
CONFIG_FILE="configs/8_shot/foodx251_cosine_5e_6_ls.yaml"
...
nohup deepspeed --master_port=29501 --num_gpus=$NUM_GPUS \
    ...
    --config $CONFIG_FILE \
    --deepspeed_config $DEEPSPEED_CONFIG > /llm_reco/dehua/code/qwen_classify/logs/foodx251_ls_5e_6_8shot.log 2>&1
